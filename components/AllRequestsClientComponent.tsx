...
export default function AllRequestsClientComponent({ allRequests }: { allRequests: any }) {
    ...
    const allRequestsAfterFilter = {
        nodes: safeRequests.filter((item: any) =>
            ...
            <div
                ...
                <div className="items-start justify-between md:flex">
                    <div className="max-w-lg">
                        <h3 className="text-gray-800 dark:text-gray-100 text-xl font-bold sm:text-2xl">
                            ALL REQUESTS
                        </h3>
                ...
                {isLoading ? (
                    ...
                    <EmptyState 
                        ...
                        description="There are currently no pending requests to display. New requests will appear here."
                        icon={

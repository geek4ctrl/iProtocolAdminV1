...
export default function AllValidatedInvitationsClientComponent({ allValidatedInvitations }: { allValidatedInvitations: any }) {
    ...
    // Ensure allValidatedInvitations is always an array
    const safeValidatedInvitations = allValidatedInvitations || [];

    const allValidatedInvitationsAfterFilter = {
        nodes: safeValidatedInvitations.filter((item: any) =>
    ...
    return (
        ...
        <>
            <div
                ...
                {isLoading ? (
                    <LoadingSpinner size="large" text="Loading validated invitations..." />
                ) : currentRecords.length === 0 ? (
                    <EmptyState 
                        title="No validated invitations found"
                        description="There are currently no validated invitations to display."
                        icon={
                        ...
                        <div className="relative w-full max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-md shadow-lg">
                            <div id="modal" style={styles}>
                                ...
                                <div className="flex justify-center" style={{ paddingBottom: "3rem" }}>
                                    <QRCode value={modalContent.userid} size={200} />
                                </div>
                            </div>
